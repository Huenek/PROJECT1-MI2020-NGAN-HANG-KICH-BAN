...
## 👥 Team & phân công (ví dụ)

| Vai trò | Tên | Việc |
|---------|-----|------|
| **Sinh kịch bản** | Nhân, Anh | Chạy `generate.py`, bơm context, giám sát điểm |
| **Tư liệu & Deep Research** | Hường, Huệ | Tạo `context/<chủ_đề>.md` dùng Gemini |
| **Video (Manim)** | Thành, Đạt | Dựng Manim từ JSON kịch bản |
| **QA & Excel** | Hùng, Chinh | Kiểm chất lượng, gom Excel, phân phối |
...
Mọi vấn đề hoặc gợi ý: tạo issue trên GitHub hoặc contact FaMI team.
